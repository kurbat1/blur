...
{
	// Read the image file
	Mat image = imread("./input/lena.png");
	...
	String window_name = "Sword";
	String window_name_blurred_with_3x3_kernel = "Sword Blurred with 3 x 3 Gaussian Kernel";
	String window_name_blurred_with_5x5_kernel = "Sword Blurred with 5 x 5 Gaussian Kernel";
